...
class CSV2MR:
    ...
    def post_item(self,item):
        ...
        map = {u'cc784d6f': '1', u'4f9a647f': '2', u'2aa59797': '11', u'8e5b7eb1': '4', u'1a3ffd3b': {'fr': '9', 'en': '8', 'it': '5', 'sp': '6'}, u'd88555ed': '3'}
...
if __name__ == '__main__':
    ...
    c2r = CSV2MR()
    c2r.run(xrn_step1=c2r.rn_step1,
            xrn_step2=c2r.rn_step2,
            xmmf_step1=c2r.mmf_step1,
            xmmf_step2=c2r.mmf_step2,
            xmmf_step3=c2r.mmf_step3, 
            xmrf_step1=c2r.mrf_step1)
